...
word_segmenter = WordSegmenterCNN(input_name=model_name, input_clusters_num=350, input_embedding_dim=40, 
                                input_hunits=40, input_dropout_rate=0.1, input_output_dim=4,
                                input_epochs=100, input_training_data='my', input_evaluation_data='my', 
