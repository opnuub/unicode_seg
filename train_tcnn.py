...
# model_name = "Thai_graphclust_2_32_no_time"
# word_segmenter = pick_cnn_model(model_name, "grapheme_clusters_tf")
# print(word_segmenter.segment_arbitrary_line("การข่มขืนโดยกระบวนการยุติธรรม"))
