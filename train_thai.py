...
from lstm_word_segmentation.word_segmenter import pick_lstm_model, pick_cnn_model
import time
...
model_name = "Thai_codepoint_2_128"
# word_segmenter = WordSegmenter(input_name=model_name, input_n=400, input_t=100000, input_clusters_num=350,
#                                input_embedding_dim=40, input_hunits=27, input_dropout_rate=0.2, input_output_dim=4,
#                                input_epochs=2, input_training_data="BEST",
